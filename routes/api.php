...
*/
    ...
    //  This Middleware for return JSON Messages
    Route::group(['middleware'=> ['return_json_message']], function (){

        //  Protected routes
        Route::group(['middleware'=> ['auth:sanctum', 'is_user_active']], function (){
        // Annonces
